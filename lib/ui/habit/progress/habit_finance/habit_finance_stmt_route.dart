...
class HabitFinanceStmtRoute extends StatefulWidget {
  final UserHabit userHabit;

  const HabitFinanceStmtRoute({Key? key, required this.userHabit}) : super(key: key);

  @override
  _HabitFinanceStmtRouteState createState() => _HabitFinanceStmtRouteState();
}

class _HabitFinanceStmtRouteState extends State<HabitFinanceStmtRoute> {
  // UI
