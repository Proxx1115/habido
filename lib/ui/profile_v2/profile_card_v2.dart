...
class ProfileCardV2 extends StatefulWidget {
  final EdgeInsets? margin;

  const ProfileCardV2({Key? key, this.margin}) : super(key: key);

  @override
  _ProfileCardV2State createState() => _ProfileCardV2State();
}

class _ProfileCardV2State extends State<ProfileCardV2> {
  @override
  void initState() {
    super.initState();
  }
      ...
      child: BlocListener<UserBloc, UserState>(
        ...
        child: BlocBuilder<UserBloc, UserState>(
          builder: (context, state) {
            return (globals.userData != null &&
                    globals.userData!.rankId != null)
                ? StadiumContainer(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                padding:
                                    EdgeInsets.fromLTRB(15.0, 4.0, 15.0, 4.0),
                                child: Row(
                                  // mainAxisAlignment:
                            ...
                            /// Button edit
                            SvgPicture.asset(Assets.editV2),
                          ],
                        ),
                      ),
                    ),
