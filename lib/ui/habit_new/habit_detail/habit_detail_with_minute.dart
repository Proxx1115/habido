...
class HabitDetailWithMinuteRoute extends StatefulWidget {
  ...
  @override
  State<HabitDetailWithMinuteRoute> createState() => _HabitDetailWithCountRouteState();
}

class _HabitDetailWithCountRouteState extends State<HabitDetailWithMinuteRoute> {
