...
class UserInfoSwitch extends StatefulWidget {
  final bool value;
...
class _CustomSwitchState extends State<UserInfoSwitch> {
  bool _value = false;
  String? text;
  ...
  Widget _switch() {
    return Switch(
      ...
      activeThumbImage:
          widget.activeAsset != null ? AssetImage(widget.activeAsset!) : null,
