...
class ApiManager {
  ...
  //   Map<String, String> headers = ApiHelper.getHttpHeaders();
  //
  //   headers.addAll({"authorization": 'Basic ' + base64Encode(utf8.encode('${request.username}:${request.password}'))});
  //
  //   return LoginResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(
  ...
  //       (await apiCaller.sendRequest(route: ApiRoutes.signUp, requestData: request, hasSessionToken: false)).data);
  // }
  //
  // static Future<BaseResponse> verify(VerifyRequest request) async {
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(route: ApiRoutes.verify, requestData: request, hasSessionToken: false)).data);
  // }
  //
  // static Future<SignUpResponse> forgotPass(ForgotPassRequest request) async {
  //   return SignUpResponse.fromJson(
  //       (await apiCaller.sendRequest(route: ApiRoutes.forgotPass, requestData: request, hasSessionToken: false)).data);
  // }
  //
  // static Future<BaseResponse> changePass(VerifyRequest request) async {
  //   return BaseResponse.fromJson(
  //       (await apiCaller.sendRequest(route: ApiRoutes.changePassVerify, requestData: request, hasSessionToken: false)).data);
  // }
  //
  // static Future<BaseResponse> changePassSettings(ChangePassRequest request) async {
  //   return BaseResponse.fromJson(
  //       (await apiCaller.sendRequest(route: ApiRoutes.changePass, requestData: request, hasSessionToken: false)).data);
  // }
  //
  // static Future<BonusBalResponse> getBonusBal() async {
  //   var res = BonusBalResponse.fromJson(
  //       (await apiCaller.sendRequest(route: '/bonus-bal', requestData: BaseRequest(), httpMethod: HttpMethod.Get)).data);
  //
  //   return res;
  // }
  //
  ...
  //   var res = CustImageResponse.fromJson((await apiCaller.sendRequest(
  ...
  //       (await apiCaller.sendRequest(route: ApiRoutes.custPerson, requestData: BaseRequest(), httpMethod: HttpMethod.Get)).data);
  // }
  //
  // static Future<BaseResponse> updateCustPerson(UpdatePrivateInfoRequest request) async {
  //   return BaseResponse.fromJson(
  //       (await apiCaller.sendRequest(route: ApiRoutes.custPerson, requestData: request, httpMethod: HttpMethod.Put)).data);
  // }
  //
  // static Future<GetDictListResponse> getDicts(GetDictListRequest request) async {
  //   return GetDictListResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(route: ApiRoutes.uploadPhoto, requestData: request)).data);
  // }
  //
  // static Future<GetAddressResponse> getAddresses() async {
  //   return GetAddressResponse.fromJson(
  //       (await apiCaller.sendRequest(route: ApiRoutes.getAddresses, requestData: BaseRequest(), httpMethod: HttpMethod.Get)).data);
  // }
  //
  ...
  //       (await apiCaller.sendRequest(route: ApiRoutes.getBankAccounts, requestData: BaseRequest(), httpMethod: HttpMethod.Get)).data);
  //
  ...
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(route: ApiRoutes.addOrUpdateBankAcnt, requestData: request)).data);
  // }
  //
  ...
  //       (await apiCaller.sendRequest(route: ApiRoutes.financeInfo, requestData: BaseRequest(), httpMethod: HttpMethod.Get)).data);
  // }
  //
  // static Future<BaseResponse> updateFinanceInfo(UpdateFinanceInfoRequest request) async {
  //   return BaseResponse.fromJson(
  //       (await apiCaller.sendRequest(route: ApiRoutes.financeInfo, requestData: request, httpMethod: HttpMethod.Put)).data);
  // }
  //
  // static Future<BaseResponse> calculateLimit() async {
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(route: ApiRoutes.calculateLimit, requestData: BaseRequest())).data);
  // }
  //
  ...
  //     (await apiCaller.sendRequest(route: ApiRoutes.param, requestData: BaseRequest(), httpMethod: HttpMethod.Get)).data,
  //   );
  //
  ...
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(route: ApiRoutes.contractRequest, requestData: BaseRequest())).data);
  // }
  //
  // static Future<GetDictResponse> getDict(GetDictRequest request) async {
  //   return GetDictResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return BaseResponse.fromJson((await apiCaller.sendRequest(route: ApiRoutes.updateAddress, requestData: request)).data);
  // }
  //
  // static Future<ActiveLoansResponse> getAllLoans() async {
  //   return ActiveLoansResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return NotifListResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return LoanInfoResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return BranchListResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   var res = LoanPayInfo.fromJson((await apiCaller.sendRequest(
  ...
  //   return LoanStatementResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return ScrEmojiResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return ScrQuestionsResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return ScoringResultResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return RelativeListResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return BannerResponse.fromJson((await apiCaller.simpleHttpRequest(
  ...
  //   return BlogResponse.fromJson((await apiCaller.simpleHttpRequest(
  ...
  //   var res = DpAcntsResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   var res = BaseResponse.fromJson((await apiCaller.sendRequest(
  ...
  //   return FriendListResponse.fromJson((await apiCaller.sendRequest(
