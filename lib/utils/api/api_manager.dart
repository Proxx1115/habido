...
class ApiManager {
  ...
  static Future<OnBoardingSaveResponse> saveOnBoarding(OnBoardingSaveRequest answer) async {
    return OnBoardingSaveResponse.fromJson(
      await httpUtils.sendRequest(path: HttpPath.onBoardingSave, objectData: answer),
    );
  }
