...
import 'package:habido_app/models/notif_list_with_date_response.dart';
...
class ApiManager {
  ...
  static Future<DashboardHabitTemplatesResponse>
      dashboardHabitTemplates() async {
  ...
  static Future<NotifListWithDateResponse> lastNotifs() async {
    return NotifListWithDateResponse.fromJson(
      await httpUtils.sendRequest(
        path: HttpPath.lastNotifs,
        httpMethod: HttpMethod.get,
      ),
    );
  }

  static Future<NotifListWithDateResponse> oldNotifs(int notifId) async {
    return NotifListWithDateResponse.fromJson(
      await httpUtils.sendRequest(
        path: HttpPath.oldNotifs + '/$notifId',
        httpMethod: HttpMethod.get,
      ),
    );
  }
  ...
  static Future<UserHabitProgressLog> getHabitProgressLog(
      int userHabitId, String planDate) async {
    return UserHabitProgressLog.fromJson(
      await httpUtils.sendRequest(
        path: HttpPath.getHabitProgressLog +
            '?userHabitId=$userHabitId&planDate=$planDate',
        httpMethod: HttpMethod.get,
      ),
    );
  }
  ...
  static Future<UserHabitDetailsFeelingResponse> getUserHabitDetailsFeelingNext(
      int userHabitId, int planId) async {
    return UserHabitDetailsFeelingResponse.fromJson(
      await httpUtils.sendRequest(
        path: HttpPath.userHabitDetailsFeelingNext +
            '?userHabitId=$userHabitId&planId=$planId',
        httpMethod: HttpMethod.get,
      ),
    );
  }
  ...
  /// OnBoarding
  static Future<OnBoardingStartResponse> getOnBoardingQuestion() async {
    return OnBoardingStartResponse.fromJson(
      await httpUtils.sendRequest(
        path: HttpPath.onBoardingQuestions,
      ),
    );
  }

  static Future<OnBoardingSaveResponse> saveOnBoarding(
      OnBoardingSaveRequest answer) async {
    return OnBoardingSaveResponse.fromJson(
      await httpUtils.sendRequest(
          path: HttpPath.onBoardingSave, objectData: answer),
    );
  }
