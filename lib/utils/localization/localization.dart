...
class LocaleKeys {
  ...
  static String get oauthInfo => 'Та Habido 1.0 аппликейшнд бүртгэлтэй утасны дугаар, эсвэл имейл хаягаа оруулна уу';
...
//
  ...
  static String get addNew => 'Хүссэн дадлаа хэвшүүлэх';

  static String get newPsyTest => 'Шинэ';

  static String get toEvaluate => 'Үнэлгээ өгөх';

  static String get retakeTest => 'Дахин бөглөх';
